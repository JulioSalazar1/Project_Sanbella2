...
// partiendo de que ya tenemos creado un objecto ClientData previamente utilizamos el contexto
	...
	public function update(){
		$sql = "update ".self::$tablename." set name=\"$this->name\",lastname=\"$this->lastname\",address=\"$this->address\",phone=\"$this->phone\",email=\"$this->email\",gender=\"$this->gender\",day_of_birth=\"$this->day_of_birth\" where id=$this->id";
		Executor::doit($sql);
	}
